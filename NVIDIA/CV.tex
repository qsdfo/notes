...
\simple{
\skillgroup{EDITE grant for doctoral studies}
{
\textit{3 years funded Ph.D.}\\
}
}

\section{Publication}
\simple{
\skillgroup{Ongoing : Live Orchestral Piano, a system for real-time orchestral music generation}
{
\textit{Léopold Crestel, Philippe Esling}\\
International Conference on Computational Creativity (ICCC), Paris, 2016
}

\skillgroup{Deep symbolic learning for musical orchestration analysis and generation}
{
\textit{Léopold Crestel}\\
M.Sc. Thesis, IRCAM-UPMC, 2015\\
}
}
